...
generateRandomOptions(sum){
   ...
   // console.log(randomNumberArray);
    ...
    for (let i = 0; i<3; i++){
    let addSubtact = this.randomNumber(0,1);
     let result = sum;
    if (addSubtact === 1){
...
playGame(){
    // console.log(this.randomNumber(20,52), this.randomNumber(20,52))
...
checkResults(option){
    console.log('checkResults call ' + option);
...
renderMessage(){
    if(this.state.correct){
       ...
       return <h3>ohh ohhh! Hit the button to Play Again </h3>
    }
}
